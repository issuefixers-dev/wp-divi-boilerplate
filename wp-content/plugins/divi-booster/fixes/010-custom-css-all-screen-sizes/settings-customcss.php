...
function db010_add_setting($plugin) { 
	...
	?>
<input type="checkbox" value="1" checked="checked" disabled/> Custom CSS as defined in <a href="<?php echo (is_divi24($plugin->config['theme']))?'admin.php?page=et_divi_options':'themes.php?page=core_functions.php'; ?>">Divi ePanel</a>: <br>
